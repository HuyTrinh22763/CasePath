        ...
        <div className="mx-auto flex max-w-[980px] flex-col items-center gap-6 text-center">
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl flex flex-col items-center overflow-hidden py-2" style={{ color: '#19304D' }}>
            <span className="block animate-in fade-in slide-in-from-right-1/2 duration-1000 fill-mode-forwards">
              Think in <span className="font-black bg-clip-text text-transparent bg-[linear-gradient(90deg,#19304D,#4e6e91,#19304D)] bg-[length:200%_auto] animate-gradient">Cases</span>.
            </span>
            <span className="block animate-in fade-in slide-in-from-left-1/2 duration-1000 delay-300 fill-mode-forwards">
              Move with <span className="font-black bg-clip-text text-transparent bg-[linear-gradient(90deg,#155D4C,#239E82,#4CCEB0,#239E82,#155D4C)] bg-[length:200%_auto] animate-gradient">Purpose</span>.
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mt-4 animate-in fade-in zoom-in duration-700 delay-700 fill-mode-forwards">
            <Button asChild size="lg" className="animate-pulse h-14 px-10 text-lg rounded-full group shadow-xl transition-all border-b-4 font-bold hover:scale-105 active:scale-95" style={{ backgroundColor: '#239E82', color: 'white', borderColor: 'rgba(25, 48, 77, 0.1)' }}>
              <Link href="/blog">
                VIEW BLOGS
              </Link>
            </Button>
